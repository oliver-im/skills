...
- **Merge** tests that exercise one contract with different inputs, for example into a table-driven test. Trimming the rows of an existing table rarely saves maintenance.
